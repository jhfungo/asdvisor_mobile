...
const ChildProfilePage = () => {
  return (
    <View className="mx-3 px-3">
      <Text className=" mt-8 text-left text-7xl font-bold">Child Details</Text>
      ...
      <View className="mt-8 flex-row">
        ...
        <View className='pr-10'>
          <Text className="ml-10 text-wrap pl-6 text-xl font-bold">Hypersensory Overload and Autism Spectrum Disorder</Text>
        </View>
      </View>
    </View>
  );
